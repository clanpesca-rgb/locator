...
- [x] **3. Nascondere gli esauriti dal catalogo** — ✅ **CHIUSA l'8/8/2026**: la spunta WooCommerce era già attiva e la verifica live conferma che le categorie (Luccio 220 prodotti, Tuning 45) non mostrano alcun "Esaurito" in griglia. Le schede esaurite restano raggiungibili solo da URL diretto (comportamento standard, innocuo). Nessuna azione necessaria.
- [ ] **4. P.IVA e venditore coerente** — ⏸ **IN ATTESA: dipende dal titolare (Carson Srl)**. Chiarimento dell'8/8: il sito è di proprietà di Carson Srl, il negozio Clan Pesca lo gestisce e spedisce. Il fix non è cambiare conti o intestazioni, ma dire la stessa cosa ovunque: oggi le condizioni indicano come venditore "Clan Pesca srl" mentre il bonifico va a Carson Srl, e nessuna P.IVA è esposta (per un e-commerce è anche un obbligo di legge). Riga pronta da concordare col titolare e incollare nel footer (via "Footer Blocks"): *"clanpesca.com è gestito da Carson Srl — P.IVA … — in collaborazione con il negozio Clan Pesca, Via Treves 54, Vergiate (VA)"*, allineando condizioni e istruzioni bonifico alla stessa società. Per la formulazione esatta, un passaggio col commercialista di Carson chiude ogni dubbio. ⏱ 10 min una volta concordata. **Fatto quando:** footer, condizioni e pagina pagamenti nominano la stessa società con P.IVA.
